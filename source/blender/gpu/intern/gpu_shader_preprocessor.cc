...
struct Preprocessor {
 ...
 public:
  ...
  void optimize()
  {
    ...
    entry_points.append(lex_.hash("nodetree_depth_offset"));
    entry_points.append(lex_.hash("nodetree_npr"));
    entry_points.append(lex_.hash("nodetree_filter"));
    entry_points.append(lex_.hash("nodetree_light_shader"));
