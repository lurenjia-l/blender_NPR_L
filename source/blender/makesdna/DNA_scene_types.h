...
enum eSceneEEVEE_Flag : int {
  ...
  SCE_EEVEE_PERFORMANCE_PROFILER = (1 << 29),
  SCE_EEVEE_PERFORMANCE_PROFILER_STAGE_LIST = (1 << 30),
  SCE_EEVEE_PERFORMANCE_PROFILER_SORT_BY_TIME = (1 << 31),
};
...
enum SceneEEVEEStageOutputView {
  SCE_EEVEE_STAGE_VIEW_OFF = 0,
  SCE_EEVEE_STAGE_VIEW_BACKGROUND = 1,
  SCE_EEVEE_STAGE_VIEW_DEFERRED = 2,
  SCE_EEVEE_STAGE_VIEW_FILTER_BEFORE_VOLUME_FOG = 3,
  SCE_EEVEE_STAGE_VIEW_VOLUME_RESOLVE = 4,
  SCE_EEVEE_STAGE_VIEW_AMBIENT_OCCLUSION = 5,
  SCE_EEVEE_STAGE_VIEW_FORWARD = 6,
  SCE_EEVEE_STAGE_VIEW_FILTER_BEFORE_POSTFX = 7,
  SCE_EEVEE_STAGE_VIEW_MOTION_BLUR = 8,
  SCE_EEVEE_STAGE_VIEW_FILTER_BEFORE_DEPTH_OF_FIELD = 9,
  SCE_EEVEE_STAGE_VIEW_DEPTH_OF_FIELD = 10,
  SCE_EEVEE_STAGE_VIEW_FILTER_BEFORE_COMPOSITE = 11,
  SCE_EEVEE_STAGE_VIEW_FINAL = 12,
};
